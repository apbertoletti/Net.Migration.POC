...
3. Avoid try to rollback (or remove) migrations that has already commmited on the repository. Instead of, add a new migration with your scripts to undo what you want.
